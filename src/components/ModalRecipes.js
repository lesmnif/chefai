                        ...
                        <div
                          ...
                          className={
                            selectedRecipe === index
                              ? 'relative flex items-center space-x-3 rounded-lg border border-gray-300 bg-indigo-200 px-6 py-5 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400'
